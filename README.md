...
TAPAS Legacy is a collection of algorithms and software tools that previously 
belonged to the [TAPAS collection](https://translationalneuromodeling.github.io/tapas/), 
but are no longer actively maintained.

The TAPAS collection is a suite of algorithms and software tools developed by the
...
The tools within TAPAS Legacy are not maintained anymore and we are not offering 
user support.
